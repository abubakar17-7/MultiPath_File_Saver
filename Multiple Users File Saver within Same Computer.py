...
def SaveFile(file_path):
    ...
    users_directories = ["E:/Projects/Server/New folder (1)",
                         "E:/Projects/Server/New folder (2)",
                         "E:/Projects/Server/New folder (3)",
                         "E:/Projects/Server/New folder (4)",
                         "E:/Projects/Server/New folder (5)",
                         "E:/Projects/Server/New folder (6)",
                         "E:/Projects/Server/New folder (7)",
                         "E:/Projects/Server/New folder (8)",
                         "E:/Projects/Server/New folder (9)",
                         "E:/Projects/Server/New folder (10)",
                         "E:/Projects/Server/New folder (11)",
                         "E:/Projects/Server/New folder (12)"
                         ]
    
    def save_to_multiple_users(file_path):
        for user_directory in users_directories:
            # reciever = user_directory[26:33]
            reciever = user_directory[19:]
...
def chooseFile():
    ...
    def next_func():
        ...
        # try:
            ...
            # if not file_path:
            #     messagebox.showerror("Error", "No File Selected - Please Upload File")
            #     return
                    
            SaveFile(file_path)

        # except:
        #     messagebox.showerror("Error", "No File Uploaded - Please Upload File")
        #     return
